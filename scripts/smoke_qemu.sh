...
(
    ...
    sleep 0.1
    printf 'ver\t\r'
    wait_for_primary_log_count "Arwill 0.21.1" 2
    sleep 0.1
    printf 'sys\t\r'
    wait_for_primary_log "system: Arwill 0.21.1"
    ...
    wait_for_primary_log "version: 0.21.1"
    sleep 0.1
...
check_line "Arwill 0.21.1 ready"
...
check_line "system: Arwill 0.21.1"
...
remote_version_count=$(grep -F -c "Arwill 0.21.1" "$remote_console_log")
